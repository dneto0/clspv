...
// CHECK-DAG: [[__struct_8]] = OpTypeStruct [[_uint]]
...
// CHECK-DAG: [[__ptr_Function__arr_float_uint_7:%[0-9a-zA-Z_]+]] = OpTypePointer Function [[__arr_float_uint_7]]
// CHECK-DAG: [[__ptr_Function_float:%[0-9a-zA-Z_]+]] = OpTypePointer Function [[_float]]
...
// CHECK: [[_26]] = OpFunction [[_void]] None [[_11]]
...
// CHECK: [[_49:%[0-9a-zA-Z_]+]] = OpIAdd [[_uint]] [[_uint_0]] [[_30]]
// CHECK: [[_50:%[0-9a-zA-Z_]+]] = OpAccessChain [[__ptr_StorageBuffer_float]] [[_23]] [[_uint_0]] [[_49]]
// CHECK: OpStore [[_50]] [[_48]]
// CHECK: OpReturn
// CHECK: OpFunctionEnd
