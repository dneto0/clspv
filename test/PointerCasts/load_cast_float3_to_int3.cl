...
// CHECK-DAG: %[[UINT3_GLOBAL_POINTER_TYPE_ID:[a-zA-Z0-9_]*]] = OpTypePointer StorageBuffer %[[UINT3_TYPE_ID]]
// CHECK-DAG: %[[UINT3_DYNAMIC_ARRAY_TYPE_ID]] = OpTypeRuntimeArray %[[UINT3_TYPE_ID]]
// CHECK-DAG: %[[ARG0_STRUCT_TYPE_ID]] = OpTypeStruct %[[UINT3_DYNAMIC_ARRAY_TYPE_ID]]
...
// CHECK-DAG: %[[FLOAT3_GLOBAL_POINTER_TYPE_ID:[a-zA-Z0-9_]*]] = OpTypePointer StorageBuffer %[[FLOAT3_TYPE_ID]]
// CHECK-DAG: %[[FLOAT3_DYNAMIC_ARRAY_TYPE_ID]] = OpTypeRuntimeArray %[[FLOAT3_TYPE_ID]]
// CHECK-DAG: %[[ARG1_STRUCT_TYPE_ID]] = OpTypeStruct %[[FLOAT3_DYNAMIC_ARRAY_TYPE_ID]]
