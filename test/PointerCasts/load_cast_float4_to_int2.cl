...
// CHECK-DAG: %[[INT2_GLOBAL_POINTER_TYPE_ID:[a-zA-Z0-9_]*]] = OpTypePointer StorageBuffer %[[INT2_TYPE_ID]]
// CHECK-DAG: %[[INT2_DYNAMIC_ARRAY_TYPE_ID]] = OpTypeRuntimeArray %[[INT2_TYPE_ID]]
// CHECK-DAG: %[[ARG0_STRUCT_TYPE_ID]] = OpTypeStruct %[[INT2_DYNAMIC_ARRAY_TYPE_ID]]
...
// CHECK-DAG: %[[ARG2_STRUCT_TYPE_ID]] = OpTypeStruct %[[INT_TYPE_ID]]
