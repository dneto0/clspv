...
// CHECK-DAG: %[[UINT2_GLOBAL_POINTER_TYPE_ID:[a-zA-Z0-9_]*]] = OpTypePointer StorageBuffer %[[UINT2_TYPE_ID]]
// CHECK-DAG: %[[UINT2_DYNAMIC_ARRAY_TYPE_ID]] = OpTypeRuntimeArray %[[UINT2_TYPE_ID]]
// CHECK-DAG: %[[ARG0_STRUCT_TYPE_ID]] = OpTypeStruct %[[UINT2_DYNAMIC_ARRAY_TYPE_ID]]
...
// CHECK-DAG: %[[UINT4_GLOBAL_POINTER_TYPE_ID:[a-zA-Z0-9_]*]] = OpTypePointer StorageBuffer %[[UINT4_TYPE_ID]]
// CHECK-DAG: %[[UINT4_DYNAMIC_ARRAY_TYPE_ID]] = OpTypeRuntimeArray %[[UINT4_TYPE_ID]]
// CHECK-DAG: %[[ARG1_STRUCT_TYPE_ID]] = OpTypeStruct %[[UINT4_DYNAMIC_ARRAY_TYPE_ID]]
