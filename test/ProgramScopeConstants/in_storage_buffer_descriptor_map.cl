...
// CHECK-DAG: [[__struct_11]] = OpTypeStruct [[_uint]] [[_uint]] [[_float]]
// CHECK-DAG: [[_uint_3:%[0-9a-zA-Z_]+]] = OpConstant [[_uint]] 3
// CHECK-DAG: [[__arr__struct_11_uint_3]] = OpTypeArray [[__struct_11]] [[_uint_3]]
// CHECK-DAG: [[__struct_14]] = OpTypeStruct [[__arr__struct_11_uint_3]]
// CHECK-DAG: [[__ptr_StorageBuffer__struct_14:%[0-9a-zA-Z_]+]] = OpTypePointer StorageBuffer [[__struct_14]]
// CHECK-DAG: [[__ptr_StorageBuffer__arr__struct_11_uint_3:%[0-9a-zA-Z_]+]] = OpTypePointer StorageBuffer [[__arr__struct_11_uint_3]]
...
// CHECK-DAG: [[_uint_97:%[0-9a-zA-Z_]+]] = OpConstant [[_uint]] 97
// CHECK-DAG: [[_uint_305441741:%[0-9a-zA-Z_]+]] = OpConstant [[_uint]] 305441741
// CHECK-DAG: [[_float_1:%[0-9a-zA-Z_]+]] = OpConstant [[_float]] 1
// CHECK-DAG: [[_24:%[0-9a-zA-Z_]+]] = OpConstantComposite [[__struct_11]] [[_uint_97]] [[_uint_305441741]] [[_float_1]]
// CHECK-DAG: [[_uint_98:%[0-9a-zA-Z_]+]] = OpConstant [[_uint]] 98
// CHECK-DAG: [[_uint_4294967295:%[0-9a-zA-Z_]+]] = OpConstant [[_uint]] 4294967295
// CHECK-DAG: [[_float_1_5:%[0-9a-zA-Z_]+]] = OpConstant [[_float]] 1.5
// CHECK-DAG: [[_28:%[0-9a-zA-Z_]+]] = OpConstantComposite [[__struct_11]] [[_uint_98]] [[_uint_4294967295]] [[_float_1_5]]
// CHECK-DAG: [[_29:%[0-9a-zA-Z_]+]] = OpConstantNull [[__struct_11]]
// CHECK-DAG: [[_30:%[0-9a-zA-Z_]+]] = OpConstantComposite [[__arr__struct_11_uint_3]] [[_24]] [[_28]] [[_29]]
// CHECK-DAG: [[_31:%[0-9a-zA-Z_]+]] = OpConstantComposite [[__struct_14]] [[_30]]
