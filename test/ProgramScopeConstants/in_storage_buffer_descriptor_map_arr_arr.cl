...
// CHECK:  OpEntryPoint GLCompute [[_32:%[0-9a-zA-Z_]+]] "foo"
...
// CHECK:  [[__ptr_Private__arr__arr_uint_uint_3_uint_2:%[0-9a-zA-Z_]+]] = OpTypePointer Private [[__arr__arr_uint_uint_3_uint_2]]
...
// CHECK:  [[_20:%[0-9a-zA-Z_]+]] = OpConstantComposite [[__arr_uint_uint_3]] [[_uint_1]] [[_uint_2]] [[_uint_3]]
// CHECK:  [[_uint_5:%[0-9a-zA-Z_]+]] = OpConstant [[_uint]] 5
// CHECK:  [[_22:%[0-9a-zA-Z_]+]] = OpConstantComposite [[__arr_uint_uint_3]] [[_uint_5]] [[_uint_0]] [[_uint_0]]
// CHECK:  [[_23:%[0-9a-zA-Z_]+]] = OpConstantComposite [[__arr__arr_uint_uint_3_uint_2]] [[_20]] [[_22]]
...
// CHECK:  [[_29:%[0-9a-zA-Z_]+]] = OpVariable [[__ptr_Private__arr__arr_uint_uint_3_uint_2]] Private [[_23]]
...
// CHECK:  [[_32]] = OpFunction [[_void]] None [[_8]]
// CHECK:  [[_33:%[0-9a-zA-Z_]+]] = OpLabel
// CHECK:  [[_34:%[0-9a-zA-Z_]+]] = OpAccessChain [[__ptr_StorageBuffer_uint]] [[_30]] [[_uint_0]] [[_uint_0]]
// CHECK:  [[_35:%[0-9a-zA-Z_]+]] = OpAccessChain [[__ptr_StorageBuffer_uint]] [[_31]] [[_uint_0]]
// CHECK:  [[_36:%[0-9a-zA-Z_]+]] = OpLoad [[_uint]] [[_35]]
// CHECK:  [[_37:%[0-9a-zA-Z_]+]] = OpAccessChain [[__ptr_Private_uint]] [[_29]] [[_36]] [[_36]]
// CHECK:  [[_38:%[0-9a-zA-Z_]+]] = OpLoad [[_uint]] [[_37]]
// CHECK:  OpStore [[_34]] [[_38]]
// CHECK:  OpReturn
// CHECK:  OpFunctionEnd
