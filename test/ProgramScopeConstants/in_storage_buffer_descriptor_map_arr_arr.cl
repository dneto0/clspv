...
// CHECK-DAG: [[__arr_uint_uint_3]] = OpTypeArray [[_uint]] [[_uint_3]]
// CHECK-DAG: [[_uint_2:%[0-9a-zA-Z_]+]] = OpConstant [[_uint]] 2
// CHECK-DAG: [[__arr__arr_uint_uint_3_uint_2]] = OpTypeArray [[__arr_uint_uint_3]] [[_uint_2]]
// CHECK-DAG: [[__struct_14]] = OpTypeStruct [[__arr__arr_uint_uint_3_uint_2]]
// CHECK-DAG: [[__ptr_StorageBuffer__struct_14:%[0-9a-zA-Z_]+]] = OpTypePointer StorageBuffer [[__struct_14]]
// CHECK-DAG: [[__ptr_StorageBuffer__arr__arr_uint_uint_3_uint_2:%[0-9a-zA-Z_]+]] = OpTypePointer StorageBuffer [[__arr__arr_uint_uint_3_uint_2]]
...
// CHECK-DAG: [[_21:%[0-9a-zA-Z_]+]] = OpConstantComposite [[__arr_uint_uint_3]] [[_uint_1]] [[_uint_2]] [[_uint_3]]
// CHECK-DAG: [[_uint_5:%[0-9a-zA-Z_]+]] = OpConstant [[_uint]] 5
// CHECK-DAG: [[_23:%[0-9a-zA-Z_]+]] = OpConstantComposite [[__arr_uint_uint_3]] [[_uint_5]] [[_uint_0]] [[_uint_0]]
// CHECK-DAG: [[_24:%[0-9a-zA-Z_]+]] = OpConstantComposite [[__arr__arr_uint_uint_3_uint_2]] [[_21]] [[_23]]
// CHECK-DAG: [[_25:%[0-9a-zA-Z_]+]] = OpConstantComposite [[__struct_14]] [[_24]]
