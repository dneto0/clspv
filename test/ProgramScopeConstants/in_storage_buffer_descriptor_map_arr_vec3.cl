...
// CHECK-DAG: [[__arr_v3uint_uint_2]] = OpTypeArray [[_v3uint]] [[_uint_2]]
// CHECK-DAG: [[__struct_13]] = OpTypeStruct [[__arr_v3uint_uint_2]]
// CHECK-DAG: [[__ptr_StorageBuffer__struct_13:%[0-9a-zA-Z_]+]] = OpTypePointer StorageBuffer [[__struct_13]]
// CHECK-DAG: [[__ptr_StorageBuffer__arr_v3uint_uint_2:%[0-9a-zA-Z_]+]] = OpTypePointer StorageBuffer [[__arr_v3uint_uint_2]]
...
// CHECK-DAG: [[_21:%[0-9a-zA-Z_]+]] = OpConstantComposite [[_v3uint]] [[_uint_1]] [[_uint_2]] [[_uint_3]]
// CHECK-DAG: [[_uint_5:%[0-9a-zA-Z_]+]] = OpConstant [[_uint]] 5
// CHECK-DAG: [[_23:%[0-9a-zA-Z_]+]] = OpConstantComposite [[_v3uint]] [[_uint_5]] [[_uint_5]] [[_uint_5]]
// CHECK-DAG: [[_24:%[0-9a-zA-Z_]+]] = OpConstantComposite [[__arr_v3uint_uint_2]] [[_21]] [[_23]]
// CHECK-DAG: [[_25:%[0-9a-zA-Z_]+]] = OpConstantComposite [[__struct_13]] [[_24]]
